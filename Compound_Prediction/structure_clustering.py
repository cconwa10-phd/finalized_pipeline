...
def smile_validation(file):
    ...
    smilesdf.to_csv("/Users/ciaraconway/Documents/all_databases/Spectra/LCMSMS/all_results/_run_validate.csv")
    return smilesdf
...
def alignment_grouping(file):
    ...
    for i, group in enumerate(groups):
        ...
        for i, mol in enumerate(molL):
            if len(tempmolL) < 50 and list_length != 0:
                ...
                genpath = "/Users/ciaraconway/Documents/all_databases/Spectra/LCMSMS/all_results/images/"
    ...
    df_counts.to_csv("/Users/ciaraconway/Documents/all_databases/Spectra/LCMSMS/all_results/all_results_count.csv")
    dfNew.to_csv("/Users/ciaraconway/Documents/all_databases/Spectra/LCMSMS/all_results/all_results_clusters.csv")
...
def main():
    file = "/Users/ciaraconway/Documents/all_databases/Spectra/LCMSMS/all_results/combined_results.csv"
    #smile_validation(file)
    file2 = "/Users/ciaraconway/Documents/all_databases/Spectra/LCMSMS/all_results/_run_validate.csv"
